...
def resnet18(pretrained=True, extra_dim=0):
    ...
    if pretrained:
        load_weights_add_extra_dim(
            model, model_zoo.load_url(url=model_urls["resnet18"], model_dir="/workspace/ComfyUI/models/checkpoints/ComfyUI-MatAnyone/checkpoint"), extra_dim
        )
    return model
...
def resnet50(pretrained=True, extra_dim=0):
    ...
    if pretrained:
        load_weights_add_extra_dim(
            model, model_zoo.load_url(url=model_urls["resnet50"], model_dir="/workspace/ComfyUI/models/checkpoints/ComfyUI-MatAnyone/checkpoint"), extra_dim
        )
    return model
